...
class yudha_peminjaman_dana(models.Model):
    _name = 'yudha.peminjaman.dana'
    _order = 'docnum desc'
    _description = "yudha PINJAMAN DANA"

    docnum = fields.Char(size=100, string='No. Transaksi' , readonly=True)
    nm_trans = fields.Char(size=100, string='Nama Transaksi', default='Peminjaman Dana', readonly=True)
    ...
    type_bunga = fields.Selection([('tunggal','Efektif Tunggal'),('efektif','Efektif Anuitas'),('tetap','Tetap'),('syariah','Syariah'),('kpr','KPR')], string='Perhitungan Bunga', default='efektif',store=True,readonly=True)
    ...
    pay_ids = fields.One2many(comodel_name="yudha.peminjaman.dana.details",inverse_name="loan_id",
    ...
    def unlink(self):
        ...
        return super(yudha_peminjaman_dana, self).unlink()
    ...
    def create(self, vals):
        ...
        myquery = """SELECT max(docnum) FROM yudha_peminjaman_dana;"""
        ...
        if no_urut != None or no_urut != False:
            ...
            vals['docnum'] = 'SIMDANA/' + str(tahun2) + '/' + str(nomerurut)
        else:
            vals['docnum'] ='SIMDANA/'+ str(tahun2) + '/' + '1'
        vals['state'] = 'draft'
        ...
        return super(yudha_peminjaman_dana, self).create(vals)
    ...
    def write(self, vals):
        ...
        return super(yudha_peminjaman_dana, self).write(vals)
...
class yudha_peminjaman_dana_details(models.Model):
    _name = 'yudha.peminjaman.dana.details'
