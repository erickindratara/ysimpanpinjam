...
class yudha_peminjaman_konsumtif(models.Model):
    _name = 'yudha.peminjaman.konsumtif'
    _order = 'docnum desc'
    _description = "yudha PINJAMAN KONSUMTIF"

    docnum = fields.Char(size=100, string='No. Transaksi' , readonly=True)
    nm_trans = fields.Char(size=100, string='Nama Transaksi', default='Peminjaman Konsumtif', readonly=True)
    ...
    jns_trans = fields.Selection([('TD', 'Peminjaman Konsumtif'), ('SD', 'Pembayaran Cicilan')], string='Jenis Transaksi',default='TD', help='Jenis Transaksi')
    ...
    type_bunga = fields.Selection([('tunggal','Efektif Tunggal'),('efektif','Efektif Anuitas'),('tetap','Tetap'),('syariah','Syariah'),('kpr','KPR')], string='Perhitungan Bunga', default='tunggal',store=True,readonly=True)
    ...
    pay_ids = fields.One2many(comodel_name="yudha.peminjaman.konsumtif.details",inverse_name="loan_id",
    ...
    def unlink(self):
        ...
        return super(yudha_peminjaman_konsumtif, self).unlink()
    ...
    def create(self, vals):
        ...
        myquery = """SELECT max(docnum) FROM yudha_peminjaman_konsumtif;"""
        ...
        if no_urut != None or no_urut != False:
            ...
            vals['docnum'] = 'SIMkonsumtif/' + str(tahun2) + '/' + str(nomerurut)
        else:
            vals['docnum'] ='SIMkonsumtif/'+ str(tahun2) + '/' + '1'
        vals['state'] = 'draft'
        ...
        return super(yudha_peminjaman_konsumtif, self).create(vals)
    ...
    def write(self, vals):
        ...
        return super(yudha_peminjaman_konsumtif, self).write(vals)
...
class yudha_peminjaman_konsumtif_details(models.Model):
    _name = 'yudha.peminjaman.konsumtif.details'

    loan_id = fields.Many2one(comodel_name="yudha.peminjaman.konsumtif", inverse_name='id', string="Loan Id", required=False, default=False)
